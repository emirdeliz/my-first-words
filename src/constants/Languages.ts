...
export const TRANSLATIONS: Record<string, Translation> = {
  ...
  de: {
    ...
    basicNeeds: {
      ...
      tired: 'Ich bin müde',
      bathroom: 'Ich brauche die Toilette',
    ...
    parentalConfig: {
      ...
      goToSettings: 'Gehen Sie zu Einstellungen - Elternkonfiguration, um einige Audios zu aktivieren.',
      title: 'Elternkonfiguration',
      instructions: {
        title: 'Verfügbare Audioelemente konfigurieren',
        subtitle: 'Wählen Sie aus, auf welche Audioelemente Ihr Kind zugreifen kann. Nur aktivierte Elemente werden in der Haupt-App angezeigt.',
      },
      actions: {
    ...
    settings: {
      ...
      language: {
        title: 'Sprache',
        subtitle: 'Wählen Sie die Benutzeroberflächensprache',
      ...
      audio: {
        title: 'Audio & Ton',
        subtitle: 'Audioeinstellungen und Tonrückmeldung',
        volumeButton: 'Lautstärke einstellen',
      },
      about: {
        title: 'Über die App',
