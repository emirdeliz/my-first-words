  ...
  const testVoice = async (voiceId: string) => {
    try {
      ...
      const speechOptions: Speech.SpeechOptions = {
        ...
        pitch: 1.0,
        rate: 0.9,
        onDone: () => { console.log(`✅ Voice tested successfully: ${voiceId}`); setTestingVoice(null); },
      ...
      if (voiceId !== 'default-voice') { (speechOptions as any).voice = voiceId; }
      Speech.speak(testText, speechOptions); // Use Speech directly
